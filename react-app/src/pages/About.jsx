        ...
        <div className="container">
          <div className="row align-items-center py-5">
            <div className="col-md-8 text-white">
              ...
              <p>Somos una tienda de Perfumes, con mas de 10 años en el mercado, entregando a nuestros clientes los mejores productos y la mejor experiencia de compra.</p>
            </div>
